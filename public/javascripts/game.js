...
var init = function(player_id, game_id, chimeEnabled) {
  ...
  var cardDefinitions = {
    ...
    sturdy: makeCard(0, 0, -1, {"Stun Immunity": 2, "Ignore all movement effects applied to you this beat.": undefined, "After Activating": "You may assume the paradigm of resilience."}),
